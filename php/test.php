            ...
            <fieldset>
                <form method='get' action='envoi_test.php'>
                   ...
                   <div class="form-group">
                        ...
                        <input type="adresse"  id="adresse" placeholder="adresse" name='adresse' value='bla'>
                        </div>
                    <div class="form-group">
                        <label for="description">description</label>
                        <input type="description"  id="description" placeholder="description" name='description' value='bla'>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date_debut"  id="date_debut" placeholder="date_debut" name='date_debut' value='1992-04-11'>
                    </div>
                    <div class="form-group">
